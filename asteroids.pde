...
void asteroidCreate(int amountOfAsteroids, int sizeOfAsteroids) { //Could change this to include x/y parameters
  ...
  //Create the initial asteroids inside an array.   
 for (int i = 0; i < a; i++) { 
    //Each asteroid has a random x and y starting co-ordinate between that is between 0 and 600, but 80 away from the ship in x OR y, and a random speed between -maxSpeed, maxSpeed 
	...
	//randomly select one of the position constraints above
